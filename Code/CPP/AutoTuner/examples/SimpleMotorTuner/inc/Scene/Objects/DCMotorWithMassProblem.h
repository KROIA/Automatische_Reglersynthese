...
//#endif
//
	DCMotorWithMassProblem(const SetupSettings& setupSettings = SetupSettings(), 
						   const std::string& name = "DCMotorWithMassProblem",
...
private:
	...
	public:
		...
		TestSystem(SetupSettings setupSettings)
