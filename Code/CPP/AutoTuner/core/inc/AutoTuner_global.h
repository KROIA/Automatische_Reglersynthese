...
#include <chrono>
// Params
// <LIBRARY NAME SHORT>=AT 
//
#ifndef BUILD_STATIC
	//#pragma message("AUTOTUNER_LIB is a shared library")
	#if defined(AUTOTUNER_LIB)
		#define AUTO_TUNER_API __declspec(dllexport)
	#else
		#define AUTO_TUNER_API __declspec(dllimport)
	#endif
#else 
	//#pragma message("AUTOTUNER_LIB is a static library")
	#define AUTO_TUNER_API
#endif
...
#if defined(AUTOTUNER_LIB)
	#pragma warning (default : 4100) // Unused variables | reset to default because the Matlab API would create errors
#endif
/// USER_SECTION_END